...
public class EjercicioN2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ahora vamos a iniciar el juego. selecciones la cantidad de jugadores");
        ...
        System.out.println("ahora comensara el juego ");
        Juego j = new Juego();
        ...
        while (juegoSigue) {
            ...
            System.out.println("el  " + j.getJugador().get(turno).getNombre() + " le toca jugar ");
            juegoSigue = j.ronda(turno);
            if (juegoSigue) {
                System.out.println("el " + j.getJugador().get(turno).getNombre() + " se salva");
            } else {
                System.out.println("el  " + j.getJugador().get(turno).getNombre() + " ha sido mojado");
